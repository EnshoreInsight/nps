...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-enshore-pattern px-6 py-12">
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-6xl items-center">
        <div className="w-full rounded-[2rem] border border-white bg-white p-8 shadow-[0_24px_60px_rgba(10,53,70,0.14)] lg:p-10">
